								...
								<tr>
									...
									<c:choose>
										...
										<c:when test="${mrvo.moviName eq '분노의질주 - 더 얼티메이트'}">
											<th><a
												href="main.jsp?view=rsv&moviNum=4&moviName=분노의질주 - 더 얼티메이트">${mrvo.moviName }</a></th>
										</c:when>
										<c:when test="${mrvo.moviName eq '콰이어트플레이스2'}">
											<th><a
												href="main.jsp?view=rsv&moviNum=5&moviName=콰이어트플레이스2">${mrvo.moviName }</a></th>
										</c:when>
										<c:when test="${mrvo.moviName eq '귀멸의칼날 - 무한열차'}">
											<th><a
												href="main.jsp?view=rsv&moviNum=6&moviName=귀멸의칼날 - 무한열차">${mrvo.moviName }</a></th>
										</c:when>
										...
										<c:when test="${mrvo.moviName eq '도라에몽: 스탠바이미 2'}">
											<th><a
												href="main.jsp?view=rsv&moviNum=8&moviName=도라에몽: 스탠바이미 2">${mrvo.moviName }</a></th>
										</c:when>
										<c:when test="${mrvo.moviName eq '아야와 마녀'}">
											<th><a
												href="main.jsp?view=rsv&moviNum=9&moviName=아야와 마녀">${mrvo.moviName }</a></th>
										</c:when>
									</c:choose>
								</tr>
							</c:forEach>
				...
				<div class="span4" id="moviechart-1">
					<div class="thumbnail">
						...
						<ul class="social">
							...
							<li><button class="btn btn-warning video-btn" id="cruella"
									type="button" data-toggle="modal" data-src="yfSMTFzw-Kw"
					...
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a href="main.jsp?view=rsv&moviNum=2&moviName=컨저링3"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="conjouring3" type="button" data-toggle="modal"
									data-src="-ph-C38VJkI" data-target="#trailerModal">트레일러</button></li>
					...
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a href="main.jsp?view=rsv&moviNum=3&moviName=캐시트럭"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn" id="cashtruck"
									type="button" data-toggle="modal" data-src="SYiEc5GO0-8"
									data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>캐시트럭</h3>
						...
						<ul class="social">
							<li><a
								href="main.jsp?view=rsv&moviNum=4&moviName=분노의질주 - 더 얼티메이트"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="fastnfurious" type="button" data-toggle="modal"
									data-src="L9Y-hn2COm0" data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>분노의 질주: 더 얼티메이트</h3>
							<p style="font-size: x-small;">
					...
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a href="main.jsp?view=rsv&moviNum=5&moviName=콰이어트플레이스2"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="quietplace" type="button" data-toggle="modal"
									data-src="rf7SFaFSf5c" data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>콰이어트 플레이스 2</h3>
							<p style="font-size: x-small;">
						...
						<ul class="social">
							<li><a
								href="main.jsp?view=rsv&moviNum=6&moviName=귀멸의칼날 - 무한열차"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="demonslayermugentrain" type="button" data-toggle="modal"
									data-src="5EXgtz_seFA" data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>극장판 귀멸의 칼날: 무한열차편</h3>
							<p style="font-size: x-small;">
			...
			<div class="row-fluid team">
					...
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a href="main.jsp?view=rsv&moviNum=7&moviName=파이프라인"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn" id="pipeline"
									type="button" data-toggle="modal" data-src="KbFhzL1b8iQ"
									data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>파이프라인</h3>
				...
				<div class="span4" id="moviechart-8">
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a
								href="main.jsp?view=rsv&moviNum=8&moviName=도라에몽: 스탠바이미 2"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="standbymedoraemon" type="button" data-toggle="modal"
									data-src="IEKt_GtoAz0" data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>도라에몽 : 스탠바이미</h3>
							<p style="font-size: x-small;">
					...
					<div class="thumbnail">
						...
						<ul class="social">
							<li><a href="main.jsp?view=rsv&moviNum=9&moviName=아야와 마녀"><button
										class="btn btn-warning" type="submit">예매하기</button></a></li>
							<li><button class="btn btn-warning video-btn"
									id="earwigdndthewtch" type="button" data-toggle="modal"
									data-src="fe3r-hOOxAE" data-target="#trailerModal">트레일러</button></li>
						</ul>
						<div class="mask">
							<h3>아야와마녀</h3>
							<p style="font-size: x-small;">
...
<div class="modal fade" id="trailerModal" tabindex="-1"
	...
	style="z-index: -1; width: 800px; background: rgba(0, 0, 0, 0.7); left: 29%; right: 29%;">
	<div class="modal-dialog">
		<div class="modal-content" style="width: 800px; position: relative;">
			...
			<div class="modal-body" id="trailerSection"
				style="width: 800px; padding: 0px; margin: 0px;"></div>
		</div>
	</div>
</div>
