...
$(function() {
	...
	document.getElementById("viewDate").setAttribute("max", "2021-12-09");

	/*
	 * function load() { if(sessionStorage.getItem('viewDate') != null) {
	 * 
	 * var viewD = sessionStorage.getItem('viewDate'); var viewT =
	 * sessionStorage.getItem('viewTime');
	 * 
	 * $("#viewDate").val(viewD); $("#viewTime").val(viewT);
	 * 
